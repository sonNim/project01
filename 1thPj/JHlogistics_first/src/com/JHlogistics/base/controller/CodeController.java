...
import com.JHlogistics.base.serviceFacade.BaseServiceFacade;
import com.JHlogistics.base.serviceFacade.BaseServiceFacadeImpl;
...
public class CodeController extends MultiActionController {
	...
	public ModelAndView findDetailCodeList(HttpServletRequest request, HttpServletResponse response) {
		...
		if (logger.isDebugEnabled()) {
			logger.debug("LogisticsInfoController : findDetailCodeList 시작");
		}
