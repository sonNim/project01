...
public class WorkplaceTO extends BaseTO {
	...
	public String getWorkplaceTelNumber() {
		return workplaceTelNumber;
	}

	public void setWorkplaceTelNumber(String workplaceTelNumber) {
		this.workplaceTelNumber = workplaceTelNumber;
	}
