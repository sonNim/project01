	...
	public ArrayList<EstimateDetailTO> selectEstimateDetailList(String estimateNo) {
		...
		try {
			...
			while (rs.next()) {
				...
				bean.setDueDateOfEstimate(rs.getString("DUE_DATE_OF_ESTIMATE"));
				bean.setEstimateAmount(rs.getInt("ESTIMATE_AMOUNT"));
				bean.setEstimateDetailNo(rs.getString("ESTIMATE_DETAIL_NO"));
				bean.setEstimateNo(estimateNo);
				bean.setItemCode(rs.getString("ITEM_CODE"));
				bean.setItemName(rs.getString("ITEM_NAME"));
				bean.setSumPriceOfEstimate(rs.getInt("SUM_PRICE_OF_ESTIMATE"));
				bean.setUnitOfEstimate(rs.getString("UNIT_OF_ESTIMATE"));
				bean.setUnitPriceOfEstimate(rs.getInt("UNIT_PRICE_OF_ESTIMATE"));
				bean.getSumPriceOfEstimate();
